...
class BilingualDataset(Dataset):
    ...
    def __getitem__(self, index:Any)->Any:
        ...
        dec_num_padding = self.seq_len - len(enc_input_tokens) -1
        ...
        return{
            ...
            "decoder_mask":( decoder_input != self.pad_token).unsqueeze(0).unsqueeze(0).int() & causal_mask(decoder_input(0)), # (1, seq_len) &  (1,1, seq_len)
            "label": label, # ( seq_len)
            "src_text": src_text,
            "tgt_text": tgt_text
        }
